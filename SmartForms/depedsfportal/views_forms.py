...
from .forms import SchoolForm, StudentForm, AcademicRecordForm, SubjectGradeForm, LearningAreaForm
...
class SchoolUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def get_object(self, queryset=None):
        ...
        if not obj:
            ...
            obj = School.objects.create(school_id="123456", name="Default School", address="Address")
        return obj
...
class AcademicRecordCreateView(LoginRequiredMixin, TeacherAccessMixin, CreateView):
    ...
    def get_success_url(self):
        return reverse_lazy('teacher_dashboard') # Ideally redirect to record detail/grades
...
class SubjectGradeCreateView(LoginRequiredMixin, TeacherAccessMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        try:
            ...
            form.add_error('learning_area', 'This subject already exists for this record.')
            return self.form_invalid(form)
    
    def get_success_url(self):
        return reverse_lazy('record_detail', kwargs={'pk': self.kwargs.get('record_pk')})
...
class SubjectGradeUpdateView(LoginRequiredMixin, TeacherAccessMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse_lazy('record_detail', kwargs={'pk': self.object.academic_record.pk})
